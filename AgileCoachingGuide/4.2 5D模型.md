...
5D模型，如图4.2所示，是基于我们在第3.2节简单介绍的赞赏式询问建立起来的。它由五个阶段组成：定义，发现，设想，设计和交付。你可以把它当做引导式讨论来运作，也可以用于拟定最佳方案。
...
基于对未来的愿景和过去的最佳实践，现在我们可以检验未来哪些可能的状况是与团队密切相关的。我们帮助团队定义出他们应该关注那种或者哪些方法。同样，重要的是要保证措辞尽可能具体，并能够指导行动。
...
最终阶段的目的是确定达成目标的行动和行动计划。明确责任，使所有人都清楚由谁在什么时候做什么事情。这种澄清需要是明确而详细的，以确保没有人对在不远的将来他/她的角色产生疑义。还应该就何时跟进达成一致，从而保证和支持实施情况。设定目标的SMART原则（即，具体的、可衡量的、可实现的、相关的、及时的，详情参考 http://en.wikipedia.org/wiki/SMART_criteria ）是很有帮助的。
...
有时候我们发现，团队在向着他们梦想和设计的观念前进时会感到紧张。这些观念理论上看起来不错，但当他们开始起草具体的行动计划时，现实就会受到打击。在整个“设计”和“交付”阶段，请保持对不确定性的关注。例如，我们发现让团队成员单独判断他们对提案的看法是很有用的。我们要求他们考虑一个从0到10的数字，其中10表示绝对肯定，0表示说不清楚，然后举起那个数字数量的手指。
...
如果最终团队感觉对这个提案不太确定，问问他们如何才能提高分数。如果团队中有不同意见，问问哪些事情让人确定，哪些让他们不确定。如果他们仍然感觉不确定，帮助他们设计有时间限制的、失败安全的实验，行动的结果将成为学习成果和知识。
...
不过，这个模型赋予了引导者巨大的责任，正如你所注意到的，通过模型引导团队需要在谨慎的乐观和不谨慎的乐观之间做出仔细的平衡。从设想到交付的“落地曲线”可能会非常困难，特别是当你正在辅导的团队多年以来都没有做过什么调整的时候。想尽一切办法帮助他们：找他们的经理讨论；在正确的时机发表一些意见，把干系人的注意力吸引到正确的事情上。
